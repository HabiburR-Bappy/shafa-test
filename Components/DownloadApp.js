            ...
            <>
                <div className="row">
                    <div className="col-md-6 download_hero_img text-center">
                        <img src={liveCallImg} alt="" />
                    </div>
                    <div className="col-md-6 d-flex align-items-center">
                        <div>
                            <h3 className="title">Download the Shafa Care app</h3>
                            <p>Access video consultation with top doctors on the Practo app. Connect with doctors online, available 24/7, from the comfort of your home.</p>
