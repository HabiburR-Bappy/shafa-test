...
import userImg from '../public/assets/img/avater/default-male.png' 
import shafaImg from '../public/assets/img/logo.png' 
    ...
    return (
        <div className="row specilist_animation pb-100 d-flex">    
            ...
            <div className="right_side"> 
                ...
                <div class="__slider slider_line_1">
                    <div class="__slide-track __slide-track1">
                        {specilities?
                ...
                <div class="__slider slider_line_2">
                    <div class="__slide-track __slide-track2 pl-5">
                        {specilities?
                            specilities.map((item) => {
                                var temp =Math.floor(Math.random() * 8)
                                if(temp==0) classname = "first_class"
                ...
                <div class="__slider slider_line_3">
                    <div class="__slide-track __slide-track3 pl-3">
                    {specilities?
                            specilities.map((item) => {
                                var temp =Math.floor(Math.random() * 8)
                                if(temp==0) classname = "first_class"
                ...
                <div class="__slider __slider_line_4">
                    <div class="__slide-track __slide-track4 pl-3">
                    {specilities?
                            specilities.map((item) => {
                                var temp =Math.floor(Math.random() * 8)
                                if(temp==0) classname = "first_class"
