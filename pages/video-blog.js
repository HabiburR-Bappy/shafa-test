                                    ...
                                    console.log("item",list.videoTitle)
                                        return (
                                            <div className="col-lg-4 col-md-6 single-video-blog">
                                                <div className="modal fade" id={"a"+list.id} tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" onClick={() => pausrVideo("#a"+list.id,"#a"+list.id+ " iframe")}>
                                                    <div className="modal-dialog modal-lg" role="document">
                                                        <div className="modal-content">
                                                            ...
                                                            <div className="modal-footer justify-content-center">
                                                                ...
                                                                <button type="button" onClick={() => pausrVideo("#a"+list.id,"#a"+list.id+ " iframe")} className="btn btn-outline-primary btn-rounded btn-md ml-4" data-dismiss="modal">Close</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <a>
                                                    {
                                                        ...
                                                        src={
                                                            "https://api-admin.shafa.care/api/v3/auth/publicFile/" +
                                                             ...
                                                             alt="video"
                                                            data-toggle="modal" data-target={"#a"+list.id} />
                                                        :                                                        
                                                        <img className="img-fluid z-depth-1" src={defaultImg} alt="video"
                                                            data-toggle="modal" data-target={"#a"+list.id} />
                                                    }
                                                        <div className="overlay img-fluid z-depth-1" data-toggle="modal" data-target={"#a"+list.id}>
                                                            <h3>{list.videoTitle}</h3>
                                                            <div className="play-btn"><i class="fas fa-play"></i></div>                                                            
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
