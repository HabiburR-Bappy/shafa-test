                ...
                <div className="container">
                    <div className="row ">
                        <div className="swith m-auto">
                            <button onClick={futureFun} className={future}>Future</button>
                            <button onClick={strategyFun} className={strategy}>Strategy and Focus</button>
                            <button onClick={teamFun} className={team}>Team</button>
                        </div>
                    </div>
                    ...
                    <div className={futureArea}>
                        <div className="row pt-3">
                            <div className="about_single_content d-flex align-items-center mb-5 mt-3">
                                <h2 className="body_title motto">Motto</h2>
                                <div class="vl"></div>
                                <p>A solution for Patients  By Doctors</p>
                            </div>

                            <div className="about_single_content d-flex align-items-center mb-5 mt-3">
                                <h2 className="body_title mission">Mission</h2>
                                <div class="vl"></div>
                                <p>Build the largest <span>healthcare ecosystem</span> in the world and <span>promote healthy living empowered by technology.</span></p>
                            </div>

                            <div className="about_single_content d-flex align-items-center w-100 mb-5 mt-3">
                                <h2 className="body_title vission">Vision</h2>
                                <div class="vl"></div>
                                <div className="w-100">
                                    <p className=""><i className="fas fa-angle-right" /> A <span>  &nbsp;family doctor  &nbsp;</span> for every family.</p>
                                    <p className=""><i className="fas fa-angle-right" /> An <span>  &nbsp;e-health profile &nbsp; </span> for every person.</p>
                                    <p className=""><i className="fas fa-angle-right" /> A <span> &nbsp; health management plan &nbsp; </span> for everyone.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="strategy-area" className={strategyArea}>
                        <div className="row pt-5">
                            <div className="title-2 w-100 text-center">
                                <h2>We are a group of Doctors</h2>
                        ...
                        <div className="pt-4 row medical">
                            <div className="col-md-12 d-flex">
                                ...
                                <div className="single_doers pl-3">
                                    ...
                                    <p className=""><i className="fas fa-angle-right" />  <span>Leverage Internet &nbsp;</span> to share medical resources in real-time across regions.</p>
                                    <p className=""><i className="fas fa-angle-right" />  <span>AI Assistant &nbsp;</span> bridges the unmet demand for family doctors and release the pressure on physical medical institutions.</p>
                                </div>
                            </div>
                        </div>
                        <div className="pt-4 row user">
                            <div className="col-md-12 d-flex pt-3">
                                <img src={user} alt="medical" />
                                <div className="single_doers pl-3">
                                    <h5>User experience</h5>
                                    <p className=""><i className="fas fa-angle-right" />  <span>24 x 7 accesss &nbsp;</span> to quality healthcare with  minimal waiting time for patients.</p>
                                    <p className=""><i className="fas fa-angle-right" />  <span>Lower &nbsp;</span> patient's medical-related <span>costs</span>.</p>
                                </div>
                            </div>
                        </div>
                        <div className="pt-4 row social">
                            <div className="col-md-12 d-flex pt-3">
                                <img src={social} alt="medical" />
                                <div className="single_doers pl-3">
                                    <h5>Social </h5>
                                    <p className=""><i className="fas fa-angle-right" />Low cost and scalable model to improve <span>access to care.</span></p>
                                    <p className=""><i className="fas fa-angle-right" />improve overall <span>population health.</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
