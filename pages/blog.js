...
const Blog = () => {
    ...
    if (singleBlog && singleBlog["file"]) {
        ...
        var previousMonth = ddd + " " + monthsName[parseInt(mmm) - 1] + ", " + yyyyy
    }
        ...
        return (
            <>
                                ...
                                <div className="row ">
                                    <div className="col-md-8 d-flex flex-column">
                                        ...
                                        <div className="">
                                            {
                                                singleBlog.file ?
                                                    <img className="mb-3" src={"https://api-admin.shafa.care/api/v3/auth/publicFile/" + singleBlog.file.path} alt="blog" /> :
                                                    null
                                            }
                                        </div>
                                    </div>
                ...
                <div className="share-links">
                    <ul>
                        <li className="social-share facebook"><a href="#" onClick={FacebookFun}><i class="fab fa-facebook-f"></i></a></li>
                        <li className="social-share twitter"><a href="#" onClick={TwitterFun}><i class="fab fa-twitter"></i></a></li>
                        <li className="social-share googleplus"><a href="#" onClick={GooglePlusFun}><i class="fab fa-google-plus-g"></i></a></li>
                        <li className="social-share linkedin"><a href="#" onClick={LinkedinFun}><i class="fab fa-linkedin-in"></i></a></li>
                    </ul>
                </div>
