    ...
    var healthDetailsList = [
        {
            ...
            "description" : "Polycystic ovary syndrome (PCOS) is a common condition that affects how a woman’s ovaries work. It is a hormonal disorder causing enlarged ovaries with small cysts on the outer edges. The three main features of PCOS are:<br /><br />There are two main types of diabetes:<br /><br /><ol><li>Ovaries don't regularly release eggs (ovulation).</li><li>High levels of male hormonesin your body.</li><li>Your ovaries become enlarged and contain many fluid-filled sacs (follicles) which surround the eggs.</li></ol>",
            ...
            "expect": "<ol><li>PCOS is not a curable condition. However its symptoms can be managed with medications and hormonal therapies.</li><li>To diagnose the condition the doctor will need to know your medical history, symptoms and conduct a physical and pelvic examination.You may also need tests such as blood test and ultrasound.</li></ol>",
            "nutrition":"<ol><li>Take a balanced low calorie diet containing whole grains, fruits and vegetables.</li><li>Avoid fatty foods and processed foods.</li><li>Reduce carbohydrate intake.</li></ol>",
            "life_style":"<ol><li>Exercise regularly to maintain healthy body weight.</li></ol>",
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12">
                            <h3 className="text-center mb-4">{healthDetailsList[id-1].title}</h3>
                            <div className="health_card d-flex flex-column">
                                <h4>Description</h4>
                                <div><hr /></div>
                                <p>{ReactHtmlParser(healthDetailsList[id-1].description)}</p>
                            </div>
                            <div className="health_card d-flex flex-column">
                                <h4>Symptom</h4>
                                <div><hr /></div>
                            ...
                            <div className="health_card d-flex flex-column">
                                <h4 >Home Remedies</h4>
                                <div><hr /></div>
                                <p>{ReactHtmlParser(healthDetailsList[id-1].home_remedies)}</p>
                            </div>
